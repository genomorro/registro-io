...
Primero, en la entidad Attendance hay dos propiedades que deben ser cambiadas: checkin_at debe llamarse checkInAt, checkout_at debe llamarse checkOutAt. Cambia los nombres y verifica el funcionamiento de los formularios, métodos y templates que usen estas variables.

En el template templates/patient/show.html.twig en al dato de Check-out, si no el valor está vacío, debe aparecer un botón que registre la hora actual como valor. Para ello necesitarás declarar una función en PatientController.php que deberá llamarse CheckOutShow.
