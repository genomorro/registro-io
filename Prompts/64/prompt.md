...
Quiero que verifiques y realices los siguientes puntos del sistema y los corrijas de ser necesario:

1. Si un Patient, se encuentra asociado a un Appointment, Attendance o Visitor, el Patient no puede ser borrado.
2. Si un User está asociado a un Attendance, Stakeholder o Visitor, el User no puede ser borrado.
3. Si un Area está asociado a un Stakeholder, Visitor o Employee, el Area no puede ser borrado.
4. Si un Employee está asociado a un Visitor o Stakeholder, el Employee no puede ser borrado.
5. Como he agregado nuevas tablas a la base de datos, crea un diagrama Entidad-Relación en PlantUML de la base de datos.
