...
El bundle PagerFantaBundle está funcionando en la ruta app_appointment_index, te pido que implementes la misma solución en las rutas: app_attendance_index, app_visitor_index y app_patient_index. Toma en cuenta que app_patient_index usa una consulta DQL particular que está definida en src/Repository/PatientRepository.php

Cada página necesita mostrar 20 resultados.

La ruta app_patient_show tiene otras tres tablas, de ser posible, también implementa la paginación en esas tablas.
