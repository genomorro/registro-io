...
1. El campo dni del formulario, debe funcionar como funciona en la entidad Visitor: Las opciones de DNI son las mismas que en Visitor, y el comportamiento de los campos es igual, debe existir 'dni_other' como campo de texto libre. Actualmente, existe un controlador Stimulus que usa Visitor para funcionar, si es necesario modifica el controlador para que sirva en ambas entidades.
