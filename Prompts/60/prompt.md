# INTEGRACIÓN AREA Y EMPLOYEE IV
...
Se han creado dos nuevas entidades, Area y Employee, las cuales estoy integrando al sistema. Quiero que en la ruta app_area_show muestre una tabla que con el uso de KNP Paginator liste los Employee asociados a dicha Area. La tabla debe mostrar las propiedades `number` y `name` de la entidad Employee; además debe poder filtrar la tabla mediante esos dos valores.

Realiza ese cambio por favor.
