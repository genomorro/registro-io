...
Implementa la paginación de la tabla de la ruta app_appointment_index que está definida en la función index del controlador AppointmentController.php. Para la paginación usa el bundle KnpPaginatorBundle, EasyAdminBundle, PagerFantaBundle o Symfony UX. Elige el que esté mejor documentado. Cada página necesita mostrar 50 resultados.
