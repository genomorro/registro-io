# INTEGRACIÓN AREA Y EMPLOYEE II
...
Las entidades Visitor y Stakeholder tienen una propiedad llamada destination, que actualmente es un elemento de texto. Acabo de crear una nueva entidad llamada Area que debe ligarse con la propiedad destination en las entidades Visitor y Stakeholder. De esta manera, un Visitante tiene un Area relacionada por medio de la propiedad destination. Podrías hacer ese cambio.
