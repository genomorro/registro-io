...
El template patient/show.html.twig tiene una sección llamada Other Appointments, asegurate que dicho apartado solo muestre resultados cuya fecha sea de mañana en adelante, omitiendo las citas cuya fecha sean del día de hoy. La fecha corresponde al atributo dateAt. La variable en cuestión viene del controlador PatientController, en el método show, definido en otherAppointments. De preferencia, solo ajusta la consulta de AppointmentRepository, para que resulten solo fechas futuras.
