...
En la entidad Stakeholder existe la propiedad 'sign' que debe guardar la ruta de una imagen de una firma. Esta propiedad 'sign' se registrará solamente en `app_stakeholder_new`.

Ya existe un área de dibujo y un controlador 'signature_controller' que permite dibujar en esa área.

Implementa la funcionalidad que permita guardar la imagen del área de dibujo al momento de enviar el formulario. La imagen se guardará en la ruta 'public/uploads/stakeholder/' con el nombre "id-fecha-.svg" donde id y fecha tienen el mismo valor de la imagen que captura la propiedad evidence de WebRTC.
