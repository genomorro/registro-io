# INTEGRACIÓN AREA Y EMPLOYEE III
...
Se han creado dos nuevas entidades, Area y Employee, las cuales estoy integrando al sistema. Las entidades Visitor y Stakeholder tienen ahora la propiedad _host_ la cual tiene una relación ManyToOne con Employee. Necesito que hagas las siguientes tareas:

1. Agrega el campo _host_ a las rutas app_visitor_new y app_visitor_edit
2. Agrega el campo _host_ a las rutas app_stakeholder_new y app_stakeholder_edit
3. Asegúrate que el campo host use Autocomplete
4. Haz que app_visitor_show y app_stakeholder_show muestren el valor de host en la tabla, principalmente el nombre (name)
5. El valor de host debe enlazar a app_employee_show correspondiente.

Si tienes inconvenientes, deberás notificarme antes de proceder.
