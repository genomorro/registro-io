...
En el sistema existe la ruta `app_stakeholder_show`, que muestra la información de un registro. Quiero que esa información se exporte a PDF. Se que existe NucleosDompdfBundle[1] que puede hacer dicha tarea.

Instala el bundle e implementa la función en la ruta mencionada. Muestra la vista modificada y un ejemplo del PDF generado.

[1] https://github.com/nucleos/NucleosDompdfBundle

***

En el sistema existe la ruta `app_stakeholder_show`, que muestra la información de un registro. Quiero que esa información se exporte a PDF. Se que existe KnpSnappyBundle que puede hacer dicha tarea.
