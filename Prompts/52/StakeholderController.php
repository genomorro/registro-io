...
final class StakeholderController extends AbstractController
{
    ...
    #[Route('/{id}/export-pdf', name: 'app_stakeholder_export_pdf', methods: ['GET'])]
    public function exportPdf(Stakeholder $stakeholder, \Knp\Snappy\Pdf $knpSnappyPdf): Response
    {
        $html = $this->renderView('stakeholder/show_pdf.html.twig', [
            'stakeholder' => $stakeholder,
        ...
        return new \Knp\Bundle\SnappyBundle\Snappy\Response\PdfResponse(
            ...
            sprintf('stakeholder-%05d.pdf', $stakeholder->getId())
        );
    }
