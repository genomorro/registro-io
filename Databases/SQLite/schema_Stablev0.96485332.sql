BEGIN TRANSACTION;
CREATE TABLE IF NOT EXISTS appointment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, patient_id INTEGER NOT NULL, agenda VARCHAR(255) NOT NULL, specialty VARCHAR(255) NOT NULL, location VARCHAR(255) NOT NULL, date_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
...
CREATE TABLE IF NOT EXISTS attendance (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, patient_id INTEGER NOT NULL, check_in_user_id INTEGER NOT NULL, check_out_user_id INTEGER DEFAULT NULL, check_in_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
...
CREATE TABLE IF NOT EXISTS hospitalized (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, patient_id INTEGER NOT NULL, service VARCHAR(255) NOT NULL, bed VARCHAR(255) NOT NULL, CONSTRAINT FK_7E8E259E6B899279 FOREIGN KEY (patient_id) REFERENCES patient (id) NOT DEFERRABLE INITIALLY IMMEDIATE);
...
CREATE TABLE IF NOT EXISTS stakeholder (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, check_in_user_id INTEGER NOT NULL, check_out_user_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, dni VARCHAR(255) NOT NULL, tag INTEGER NOT NULL, company VARCHAR(255) NOT NULL, destination VARCHAR(255) NOT NULL, subject VARCHAR(255) NOT NULL, check_in_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , check_out_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
...
CREATE TABLE IF NOT EXISTS visitor (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, check_in_user_id INTEGER NOT NULL, check_out_user_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, dni VARCHAR(255) NOT NULL, tag INTEGER NOT NULL, destination VARCHAR(255) NOT NULL, check_in_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , check_out_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
